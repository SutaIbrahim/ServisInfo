...
namespace ServisInfo_API.Models
{
    ...
    public partial class ServisInfoEntities : DbContext
    {
        ...
        public virtual ObjectResult<Kompanije> esp_Recommender_GetKompanijeByKategorijaID(Nullable<int> kompanijaID, Nullable<int> kategorijaID)
        {
            var kompanijaIDParameter = kompanijaID.HasValue ?
                new ObjectParameter("KompanijaID", kompanijaID) :
                new ObjectParameter("KompanijaID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Kompanije>("esp_Recommender_GetKompanijeByKategorijaID", kompanijaIDParameter, kategorijaIDParameter);
        }
    
        public virtual ObjectResult<Kompanije> esp_Recommender_GetKompanijeByKategorijaID(Nullable<int> kompanijaID, Nullable<int> kategorijaID, MergeOption mergeOption)
        {
            var kompanijaIDParameter = kompanijaID.HasValue ?
                new ObjectParameter("KompanijaID", kompanijaID) :
                new ObjectParameter("KompanijaID", typeof(int));
        ...
        public virtual ObjectResult<DetaljiServisa_Report> esp_Report_DetaljiServisa(Nullable<int> servisID)
        {
            var servisIDParameter = servisID.HasValue ?
                new ObjectParameter("ServisID", servisID) :
                new ObjectParameter("ServisID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<DetaljiServisa_Report>("esp_Report_DetaljiServisa", servisIDParameter);
        }
    
        public virtual ObjectResult<KompanijaPrometByDate_Report> esp_Report_UkupniPrometByDate(Nullable<int> kompanijaID, Nullable<System.DateTime> datumOD, Nullable<System.DateTime> datumDO)
        {
            var kompanijaIDParameter = kompanijaID.HasValue ?
                new ObjectParameter("KompanijaID", kompanijaID) :
                new ObjectParameter("KompanijaID", typeof(int));
        ...
        public virtual ObjectResult<Kompanije> esp_Recommender_ColdStart_PreporuciKompanijeBezOcjena(Nullable<int> kompanijaID, Nullable<int> kategorijaID)
        {
            var kompanijaIDParameter = kompanijaID.HasValue ?
                new ObjectParameter("KompanijaID", kompanijaID) :
                new ObjectParameter("KompanijaID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Kompanije>("esp_Recommender_ColdStart_PreporuciKompanijeBezOcjena", kompanijaIDParameter, kategorijaIDParameter);
        }
    
        public virtual ObjectResult<Kompanije> esp_Recommender_ColdStart_PreporuciKompanijeBezOcjena(Nullable<int> kompanijaID, Nullable<int> kategorijaID, MergeOption mergeOption)
        {
            var kompanijaIDParameter = kompanijaID.HasValue ?
                new ObjectParameter("KompanijaID", kompanijaID) :
                new ObjectParameter("KompanijaID", typeof(int));
